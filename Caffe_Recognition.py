...
full_project_path = "/Users/resitkadir/Desktop/Caffe-Recognition-app"

face_dir_path = full_project_path+'/Data/face_data'
face_deploy_path=full_project_path+'/Models'
face_caffe_model =full_project_path+'/Models'

class DectectFace:
    def __init__(self,model,name,age,gender):
        self.face_dir = face_dir_path
        self.face_name = name
        self.face_age = age
        ...
        self.net = cv2.dnn.readNetFromCaffe(face_deploy_path+"/face_deploy.prototxt.txt",face_caffe_model+"/face_net.caffemodel")
    ...
    def process_image(self,inImg):
        ...
        if self.count_captures < NUM_TRAINING:
            ...
            mylines = []
            f = open(face_dir_path+"age_gender.txt","a")
...
class RecogLBPHFaces:
    def __init__(self):
        ...
        full_project_path +'/Models/age_deploy.prototxt',
        #'/Users/resitkadir/Bs_Project_Face/Models/age_net.caffemodel'
        full_project_path +'/Models/age_net.caffemodel')



        self.gender_net = cv2.dnn.readNetFromCaffe(
        #'/Users/resitkadir/Bs_Project_Face/Data/gender_deploy.prototxt',
        full_project_path +'/Models/gender_deploy.prototxt',
        full_project_path +'/Models/gender_net.caffemodel')
        self.ap = argparse.ArgumentParser()
        self.ap.add_argument("-c","--confidence",type=float,default=0.5,
                             help="minimum probability to filter weak detections")
        self.args = vars(self.ap.parse_args())
        self.net = cv2.dnn.readNetFromCaffe(
        #'/Users/resitkadir/Bs_Project_Face/Data/face_deploy.prototxt.txt',
        full_project_path +'/Models/face_deploy.prototxt.txt',
        #'/Users/resitkadir/Bs_Project_Face/Models/face_net.caffemodel'
        full_project_path +'/Models/face_net.caffemodel')
    ...
    def load_trained_data(self):
        ...
        self.names = names
        self.model.read(
        #'/Users/resitkadir/Bs_Project_Face/Models/LBPH_trained_data.xml'
        full_project_path+'/Models/LBPH_trained_data.xml'
        )
    ...
    def process_image(self,inImg):
        ...
        for i in range(0,detections.shape[2]):
            ...
            if confidence[1] < 100:
                ...
                detage = []
                detgender = []
                with open(face_dir_path+"age_gender.txt", "r") as file:
                    for item in file:
                        data = item.split()
                        if data[0] == person:
                            detage = data[1]
...
if __name__ == '__main__':
    ...
    if number == "T":
        ...
        data = full_project_path+'/LBPH_trained_data.xml'
        name = fname()
        age = fage()
        gender = fgender()
